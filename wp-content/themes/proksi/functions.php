...
function kama_pagenavi($before='', $after='', $echo=true) {
	...
	/* ================ Ќастройки ================ */
	$text_num_page = ''; // текст дл€ количества страниц. {current} заменитс€ текущей, а {last} последней. ѕример: '—траница {current} из {last}' = —траница 4 из 60
	$num_pages = 2; // сколько ссылок показывать
	$stepLink = 0; // после навигации ссылки с определенным шагом (значение = число (какой шаг) или '', если не нужно показывать). ѕример: 1,2,3...10,20,30
	$dotright_text = ''; // промежуточный текст "до".
	$dotright_text2 = ''; // промежуточный текст "после".
	$backtext = '...'; // текст "перейти на предыдущую страницу". —тавим '', если эта ссылка не нужна.
	$nexttext = '...'; // текст "перейти на следующую страницу". —тавим '', если эта ссылка не нужна.
	...
	$start_page = $paged - $half_page_start; //перва€ страница
	$end_page = $paged + $half_page_end; //последн€€ страница (условно)
...
add_theme_support( 'woocommerce' );/*поддержка темы*/
